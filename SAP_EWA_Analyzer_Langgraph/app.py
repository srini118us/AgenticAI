...
✅ Universal SAP product support (S/4HANA, SAP FIORI, SAP ECC, BusinessObjects, etc.)
...
*Note: Configure OpenAI API key for detailed recommendations.*
    ...
    def _extract_single_system_findings_simple(self, documents: List[Any], system_id: str) -> tuple:
        """ENHANCED: Extract findings for ONE specific system with comprehensive SAP EWA patterns"""
        critical_findings = []
        recommendations = []
    ...
    def _extract_multi_system_findings_simple(self, documents: List[Any]) -> tuple:
        """ENHANCED: Extract findings for multiple systems with comprehensive SAP EWA patterns"""
        all_critical_findings = []
        all_recommendations = []
